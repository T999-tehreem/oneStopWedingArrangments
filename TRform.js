...
const TRform=({navigation,route})=> {
  ...
  const sendReview = () => {
    ...
    fetch(`${firebaseUrl}/TailorReview.json`, requestoptions)
  ...
  return (
    ...
    <View style={styles.header}>
        <Icon name="arrow-back-ios" size={28} color={'orange'} onPress={()=>{navigation.navigate('Rtailors')}} />
        <Text style={{fontSize: 20,color:'orange', fontWeight: 'bold',marginRight:90}}>Tailors</Text>
      </View>
        <Text> </Text>
