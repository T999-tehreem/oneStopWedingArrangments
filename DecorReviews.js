...
const DecorReviews= () => {
  ...
  const deleteReview = (index) => {
    ...
    fetch(
      `https://mobileproject-020-default-rtdb.firebaseio.com/DecorReview/${id}.json`,
      requestOptions
    )
  ...
  const getReview = () => {
    fetch(
      'https://mobileproject-020-default-rtdb.firebaseio.com/DecorReview.json',
              ...
              renderItem={({ item, index }) => {
                return (
                  ...
                  <View style={{alignItems:'center'}}>
                    ...
                    <View
                      style={styles.box}>
                    <Text style={styles.text}>Decor ID:{item.Id}</Text>
                    <Text style={styles.text}>Decor Name:{item.Name}</Text>
