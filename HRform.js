...
const HRform=({navigation,route})=> {
  ...
  const sendReview = () => {
    ...
    fetch(`${firebaseUrl}/HotelReview.json`, requestoptions)
  ...
  return (
    ...
    <View style={styles.header}>
        <Icon name="arrow-back-ios" size={28} color={'orange'} onPress={()=>{navigation.navigate('Rhotels')}} />
        <Text style={{fontSize: 20,color:'orange', fontWeight: 'bold',marginRight:90}}>Hotels</Text>
      </View>
        <Text> </Text>
