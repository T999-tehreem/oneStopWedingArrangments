...
import { View, Text, Button,Dimensions,FlatList,TouchableHighlight,Image,SafeAreaView, ScrollView ,StyleSheet,TouchableOpacity} from 'react-native'
  ...
  const Card = ({hotel}) => {
    return (
      ...
      <TouchableHighlight
        ...
        activeOpacity={0.3}
        onPress={() => navigation.navigate('HRform', hotel)}>
