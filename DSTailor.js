...
const DSTailor = ({navigation, route}) => {
    const item = route.params;
   // console.log({item});
  return (
    <SafeAreaView style={{backgroundColor: COLORS.white}}>
      <View style={style.header}>
        <Icon name="arrow-back-ios" size={28} color={'orange'} onPress={()=>{navigation.navigate('Tailors')}} />
        <Text style={{fontSize: 20,color:'orange', fontWeight: 'bold'}}>Tailors</Text>
      </View>
